...
var selectQuery = regexp.QuoteMeta(`SELECT * FROM "bi_organisation_permission_request"`)
var countQuery = regexp.QuoteMeta(`SELECT count(1) FROM "bi_organisation_permission_request"`)

var basePath = "/requests/organisations"
var path = "/requests/organisations/{request_id}"
var approvePath = "/requests/organisations/{request_id}/approve"
var rejectPath = "/requests/organisations/{request_id}/reject"
var myPath = "/requests/organisations/my"
